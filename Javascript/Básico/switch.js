listaAdmins = [
  { nombre: "Juan", admin: true, capaDeAdministrador: 1 },
  { nombre: "Pedro", admin: false, capaDeAdministrador: 0 },
  { nombre: "Pablo", admin: true, capaDeAdministrador: 2 },
  { nombre: "Maria", admin: false },
];
